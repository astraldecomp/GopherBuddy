          ...
          chrome.storage.local.get(appConfig.storageKeys, function (items) {
            ...
            if (
              ...
              if (
                items.deviceVersion &&
                items.available &&
                items.deviceVersion < items.available
              ) {
                ...
                if (
                  domainSettings &&
                  domainSettings.allowChromeOsUpdateReminders &&
                  exMajorVersion < currMajorVersion
                ) {
                  _this.showHelp = help;
                  // Show warning icon
      ...
      chrome.runtime.sendMessage(
        ...
        function (resp) {
          ...
          chrome.alarms.create(alarmName, {
            delayInMinutes: _this.appConfigVariables["Alarm delay"] / 60,
          });
